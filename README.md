...
For a new inquiry, [view the $75 CSV service on Contra](https://contra.com/s/Yvg2MsRW-csv-preparation-split-lists-and-map-columns), [email Sam](mailto:poarchive.support@proton.me?subject=CSV%20preparation%20inquiry), or [contact Sam on Upwork](https://www.upwork.com/freelancers/~0178ba22c34ac67dda) with a small redacted or synthetic sample and an example of the output you need. I’ll review whether I can handle it and reply with a fixed scope, price and delivery date before you commit. Please do not send a full customer export with your first message or put private data in a GitHub issue.
